...
![img](https://pic4.zhimg.com/80/v2-6f2cdbb2e228a23d26ba303c9e958017_720w.jpg)

其中 wk 是句子 Si 及 Sj 都有的公共词组，分母是词组的数量。当然，也可以用句子的余弦相似度来计算，但是词组本身就得包含向量值了，这些词组，可以称为 word vector。

### Word Vector

词组在中文里涉及到分词，有不同的工具可以用来分词表来构建语料的词向量表，比如有的用 [word2vec](https://pathmind.com/wiki/word2vec)，有的用 [GloVe](https://nlp.stanford.edu/projects/glove/)。话说，除了上面的模型、算法之外，语料可是相当重要的基础资源呀。
