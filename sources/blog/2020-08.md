...
我用 Lua 内建的 table 实做了一把，时间效率是很高效的，空间的话，插入 number，1000W 级别的插入，内存大概 6G。
...
以上使用 cdata 描述元素关系已有实做，地址 [ffi_list.lua](https://github.com/lalawue/list.lua) 及 [ffi_avl.lua](https://github.com/lalawue/ffi_avl.lua)。
